...
},{}],"js/script_personnage.js":[function(require,module,exports) {
"use strict";
...
function pagePersonnages() {
  function pagination() {
    ...
    pages.addEventListener("click", function (e) {
      var nomPersonnage = document.querySelector(".container__personnages");
      nomPersonnage.innerHTML = "";
      var idPage = e.target.getAttribute("id");
      var url = "https://rickandmortyapi.com/api/character?page=" + idPage;
      (0, _functions._fetchData)(url).then(function (personnages) {
  ...
  function pikcSpeciesInfos() {
    var containerSpecies = document.querySelector(".container__species"); // tableau pour récupérer les url de toutes les pages

    var uriS = []; // tableau dans lequel sera insérer les différents types de lieux

    var listSpecies = []; //boucles sur les uri de tous les pages qu'on insère dans le tableau uriS

    for (var index = 0; index < 18; index++) {
      uriS.push("https://rickandmortyapi.com/api/character?page=" + index);
    }

    (0, _functions._fetchDataAll)(uriS).then(function (personnages) {
      personnages.forEach(function (personnage) {
        personnage.results.forEach(function (res) {
    ...
    function createListspecies() {
      var speciesArray = _toConsumableArray(new Set(listSpecies));

      speciesArray.sort();

      for (var i = 0; i < speciesArray.length; i++) {
        var radioButton = speciesArray[i];
  ...
  function createPersonnages(personnages) {
    var containerPersonnages = document.querySelector(".container__personnages"); //console.log(personnages);
  ...
  function createPersonnage(personnage) {
    return "<div class=\"personnage\">\n                <h2 class=\"personnage__name\" data-url=\"".concat(personnage.url, "\">").concat(personnage.name, "</h2>\n                <p class=\"personnage__status\">Status : ").concat(personnage.status, "</p>\n                <p class=\"personnage__species\">Species : ").concat(personnage.species, "</p>\n                <p class=\"personnage__type\">Type : ").concat(personnage.type, "</p>\n                <p class=\"personnage__gender\">Gender : ").concat(personnage.gender, "</p>\n            </div>");
  }
  ...
  function showSpecies(e) {
    ...
    var url = "https://rickandmortyapi.com/api/character?species=" + species;
    fetch(url).then(function (resp) {
      return resp.json();
    }).then(function (character) {
      var personnages = character.results;
      console.log(character.results);
      var str = personnages.forEach(function (personnage) {
  ...
  function showInfosPersos(event) {
    ...
    (0, _functions._fetchData)(event.target.dataset.url).then(function (personnages) {
      console.log(personnages);
      (0, _functions._fetchDataAll)(personnages.episode).then(function (episodes) {
        var modalPersonnages = document.querySelector(".modal__personnages");
  ...
  function createEpisode(episodes) {
    ...
    episodes.forEach(function (episode) {
      str += "<div class=\"modal__container\">\n                            <div class=\"modal__card\">\n                                <p>Episode : ".concat(episode.episode, "</p>\n                                <a class=\"card__name\">Name : ").concat(episode.name, "</a>\n                                <p>released date : ").concat(episode.air_date, "</p>\n                            </div>\n                        </div>");
    });
    str += "</div>\n                </div>";
    return str;
  }
  ...
  function eventClickTitle() {
    var titles = document.querySelectorAll(".container__personnages .personnage__name");
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script_personnage.js"], null)
//# sourceMappingURL=/script_personnage.d2b5630a.js.map