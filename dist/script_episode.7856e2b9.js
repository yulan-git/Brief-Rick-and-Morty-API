...
},{}],"js/script_episode.js":[function(require,module,exports) {
"use strict";
...
function pageEpisode() {
  var container = document.querySelector(".container_episode");
  var persso = document.querySelector(".page_perso");
  ...
  back.addEventListener("click", function () {
    ...
    persso.innerHTML = ""; // location.reload();
  });
  var pages = document.querySelector(".pages");
  console.log(pages);
  pages.addEventListener("click", function (e) {
    var episode = document.querySelector(".container_episode");
    episode.innerHTML = "";
    var idPage = e.target.getAttribute("id");
    var url = "https://rickandmortyapi.com/api/episode?page=" + idPage;
    console.log(url);
    (0, _functions._fetchData)(url).then(function (data) {
      // console.log(data);
      for (var i = 0; i < data.results.length; i++) {
        firstfontion(data, i);
        var dives = document.querySelectorAll(".dives");
    ...
    function newFunctionpage1(dives, data) {
      var _loop = function _loop(a) {
        dives[a].addEventListener("click", function () {
          ...
          for (var ch = 0; ch < data.results[a].characters.length; ch++) {
            // console.log(data.results[a].characters[ch]);
            fetch(data.results[a].characters[ch]).then(function (res) {
              return res.json();
            }).then(function (data) {
              // console.log(data);
              persso.innerHTML += " \n                    <div class=\"episode__content\">\n                        <div class=\"image\">\n                        <img src=\"".concat(data.image, "\" alt=\"\">\n                        </div>\n                        <div class=\"info_pers\">\n                            <p>Nom : ").concat(data.name, "</p> \n                            <p>Genre : ").concat(data.genre, "</p>\n                            <p>Species : ").concat(data.species, "</p> \n                            <p>Type : ").concat(data.type, "</p>\n                        </div>\n                    </div>");
            });
          }
        });
      };
    ...
    function firstfontion(data, i) {
      container.innerHTML += "<div class=\"dives\">\n            <h1 class=\"name_episode\">Nom episode : <span class=\"nom-epis\"> ".concat(data.results[i].name, "</span></h1> \n            <h2>").concat(data.results[i].episode, "</h2>\n\n        </div>");
    }
  });
}
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script_episode.js"], null)
//# sourceMappingURL=/script_episode.7856e2b9.js.map